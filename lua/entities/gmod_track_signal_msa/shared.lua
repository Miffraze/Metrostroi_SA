...
ENT.TrafficLightModels[0] = {
	...
	boxnamestart = Vector(13.5,33.5,52.25),
...
ENT.TrafficLightModels[3] = {
	...
	[1]	= { Vector(0,0,0), "models/signals_msa/outdoors/light2_beton.mdl", {
				[0] = Vector(0,-27,56.2),
				[1] = Vector(0,-27,45.2),
				["glass"]	= {
	...
	[2]	= { Vector(0,0,0), "models/signals_msa/outdoors/light3_beton.mdl", {
				[0] = Vector(0,-27,67.2),
				[1] = Vector(0,-27,56.2),
				[2] = Vector(0,-27,45.2),
				["glass"]	= {
...
ENT.TrafficLightModels[4] = {
	...
	stationboxoffset =	Vector(13,38,50),
	boxnamestreet =		Vector(11.5,35,50),
...
ENT.TrafficLightModels[6] = {
	...
	[1]	= { Vector(0,0,0), "models/signals_msa/outdoors/light2_metal.mdl", {
	...
	[2]	= { Vector(0,0,0), "models/signals_msa/outdoors/light3_metal.mdl", {
				[0] = Vector(0,-27,138),
				[1] = Vector(0,-27,127),
				[2] = Vector(0,-27,116),
				["glass"]	= {
